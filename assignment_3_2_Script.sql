...
-- ******* CULTURE ********
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Buckingham Palace', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\Buckingham_Palace.jpg', 0, 'Buckingham Palace is the official residence and administrative headquarters of the British monarch and has been so since the accession to the throne of Queen Victoria in 1837', 0, 'Culture')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Tower of London', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\tower_of_london.jpg', 0, 'The Tower of London is an internationally famous monument and one of England''s most iconic structures. William the Conqueror built the White Tower in 1066 as a demonstration of Norman power, siting it strategically on the River Thames to act as both fortress and gateway to the capital.', 0, 'Culture')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Big Ben', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\big_ben.jpg', 0, 'The Houses of Parliament and Elizabeth Tower, commonly called Big Ben, are among London''s most iconic landmarks and must-see London attractions. Technically, Big Ben is the name given to the massive bell inside the clock tower, which weighs more than 13 tons', 0, 'Culture')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Tate Modern', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\tate_modern.jpg', 0, 'Tate Modern is London''s new modern art gallery displaying modern and contemporary art from 1900 to the current day. It occupies the converted brick clad Bankside power station on the south bank of the River Thames and opposite St Pauls''s cathedral.', 0, 'Culture')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('The Emirates Stadium', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\emirates_stadium.jpg', 0, 'The Emirates Stadium (known as Ashburton Grove prior to sponsorship, and as Arsenal Stadium for UEFA competitions) is a football stadium in Holloway, London, England, and the home of Arsenal.', 0, 'Culture')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('St. Paul''s', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\st_pauls.jpg', 0, 'St. Paul''s Cathedral is an iconic part of London''s skyline. After being destroyed four times throughout history, the current cathedral – designed by Christopher Wren – has lived through three centuries, and its dome is the second largest in the world at 366 feet high.', 0, 'Culture')

-- ******* Food ********
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Duck & Waffle', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\Duck_Waffle.jpg', 0, 'Since this is the signature dish, it’s a damn good thing they nailed it. Taking the humble sweet & savory mash up to new heights, it’s made even better with a side of the best view in town, and is accessible 24 hours a day.', 0, 'Food')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('St. John Bar & Restaurant', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\St_John_Bar_Restaurant.jpg', 0, 'For years people have journeyed down to the St. John Bakery on Saturday mornings with the flicker of hope they won''t be sold out, and frequently met with disappointment and thoughts of “well maybe next time.” Yeah, these guys are that good. Luckily, now they’re available in other locations, but of course they’re gone pretty quick.', 0, 'Food')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Chiltern Firehouse', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\Chiltern_Firehouse.jpg', 0, 'Actually more like a mini brioche bun stuffed with crab, they are the palm-sized balls that people keep clamoring over, when they can peel their eyes away from the celebs trying to hide in the dining room.', 0, 'Food')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Poppies', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\Poppies.jpg', 0, 'Having been in the F&C game since the mid 1940s, it’s safe to say they know what they’re doing. Fresh, flaky, and perfectly golden, this is the real deal.', 0, 'Food')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Hawksmoor', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\hawksmoor.jpg', 0, 'Whether or not Hawksmoor has the best steaks in town (and it probably does), the experience here is so much more than just the amazing beef. Just ask the cocktail you’re going to wash this down with.', 0, 'Food')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Patty & Bun', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\Patty_Bun.jpg', 0, 'This is how burgers are supposed to be: simple, cooked to perfection, smothered in cheese (and of course you added bacon), and so juicy it’s dripping.', 0, 'Food')

---- ******* Shopping ********
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Oxford Street', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\oxford-street-674045.jpg', 0, 'The heart of London shopping, bustling Oxford Street has more than 300 shops, designer outlets and landmark stores: here you can find some of the best shopping in London.', 0, 'Shopping')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Regent Street and Jermyn Street', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\94814-640x360-regent-street-twilight-640.jpg', 0, 'An impressively elegant shopping street, Regent Street offers a good range of mid-priced fashion stores alongside some of the city''s oldest and most famous shops, including Hamleys, Liberty andThe Apple Store. Nearby, historic Jermyn Street is renowned for men''s clothing shops and is so typically British it''s enough to bring out the old-fashioned gent in anyone! Jermyn Street is particularly well known for its bespoke shirt makers such as Benson & Clegg and shoe shops including John Lobb.', 0, 'Shopping')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Bond Street and Mayfair', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\969-640x360-bond_street-640.jpg', 0, 'Whether you want to splash out on the very best in designer clothes or just love luxury window shopping, Bond Street and Mayfair are the ideal places to go for some extravagant retail therapy. Popular with celebrities on a spree, this is probably London''s most exclusive shopping area, home to big names, including Burberry, Louis Vuitton and Tiffany & Co. Neighbouring South Molton Street boasts iconic fashion store Browns. ', 0, 'Shopping')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Westfield', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\94807-640x360-westfield-stratford-640.jpg', 0, 'Westfield has two major shopping centres in London at White City and Stratford. Westfield London is home to high street favourites including Debenhams, Next, Marks & Spencer and House of Fraser, along with luxury brands, such as Louis Vuitton, Jimmy Choo, All Saints and Ted Baker. There''s also a cinema, gym, several bars and restaurants, all under one roof! If you''re a fan of shopping centres, don''t miss Westfield Stratford City in East London, which boasts 250 shops plus 70 places to dine, making it one of the largest shopping malls in Europe', 0, 'Shopping')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Covent Garden', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\94803-640x360-covent-garden-inside-640.jpg', 0, 'Whether you want hip fashion, unique gifts, rare sweets or one-off handmade jewellery, Covent Garden is a great place to explore. Stock up on the latest urban streetwear, funky cosmetics and shoes on Neal Street, check out imaginative arts and crafts at Covent Garden Market or just window shop around the stores. Don''t miss Floral Street, Monmouth Street, St Martin''s Courtyard, Shorts Gardens, Seven Dials and picture-pretty Neal''s Yard for a true taste of London''s most distinctive shopping area.', 0, 'Shopping')

---- ******* Night Life********
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Printworks London', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\printworks.jpg', 0, 'Party among the industrial decor at this 5,000-capacity venue in Canada Water that was once Western Europe''s largest printing press complex. Let your hair down with drum''n''bass, hip hop and dance beats in Printworks London''s cavernous printing hall, and look out for headline shows from world greats, such as Pendulum and The Chemical Brothers.', 0, 'Night_Life')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Studio 338', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\studio-338.jpg', 0, 'Continue until dawn at Studio 338, where you''ll find sets from world-class DJs, a state-of-the-art sound system and top club nights, including the venue''s much-loved Sankeys. The huge club, which has terrace that''s open all night (and heated in winter), is a short walk from The O2 in North Greenwich.', 0, 'Night_Life')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('XOYO', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\xoyo-going-off.jpg', 0, 'Show off your moves at this two-room nightclub close to the Old Street roundabout in Shoreditch.  Renowned for attracting cutting-edge house, techno and dance acts, XOYO has hosted the likes of Friendly Fires, Mark Ronson, Mylo, Alex Metric, and Ms Dynamite at its headline shows and regular London club nights.', 0, 'Night_Life')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Fabric', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\fabriclondon.jpg', 0, 'Experience one of the capital''s most famous clubbing spots with a visit to Fabric in Farringdon. The legendary London club features three rooms, including one with a “bodysonic” dancefloor, and has hosted some of the world''s biggest DJs. You''ll find electro, techno and disco music, as well as drum’n’bass and grime, pumping from the speakers.', 0, 'Night_Life')
--insert into dbo.PointsOfInterest (name, picture, numViews, poiDescription,	poiRank, category)
--values('Ministry of Sound', 'C:\Users\user\Google Drive\School\web develop\Ass3.2\misc\Dolby_Atmos_at_Ministry_of_Sound.jpg', 0, 'Join the revellers at Ministry of Sound, which has been entertaining Londoners for more than 25 years and spawned a record label in the process. One of the most popular clubs in London, it boasts four bars, four dancefloors and five distinctive rooms, and still draws big names such as Paul Oakenfold. Book tickets in advance, and arrive early to avoid long queues.', 0, 'Night_Life')
